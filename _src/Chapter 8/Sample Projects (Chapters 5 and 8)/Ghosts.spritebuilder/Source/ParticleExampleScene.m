...
@implementation ParticleExampleScene
+(CCScene*)scene
{
...
-(id)init
{
	if ((self=[super init]))
	{
		...
		CCLabelTTF *lblTitle = [CCLabelTTF labelWithString:@"Particle Example" fontName:@"ArialMT" fontSize:20];
